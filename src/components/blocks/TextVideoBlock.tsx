...
import { TextVideoBlock } from '@/types/editor';
...
interface TextVideoBlockProps {
  block: TextVideoBlock;
  isPreview?: boolean;
  interactive?: boolean;
}

const TextVideoBlockComponent: React.FC<TextVideoBlockProps> = ({
  block,
  isPreview = false,
  interactive = true
}) => {
...
export default TextVideoBlockComponent;
