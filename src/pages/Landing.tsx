...
import { ArrowRight, Sparkles, BarChart2, Check, Shield, Clock, Star, Layout, Target, Zap, TrendingUp, Award, Users, ThumbsUp, Menu, X } from 'lucide-react';
...
const Landing: React.FC = () => {
  ...
  const plans = [{
    ...
    price: '0',
    period: '/mês',
    features: ['3 descrições por mês', 'Templates básicos', 'SEO básico', 'Suporte por e-mail'],
    cta: 'Começar Grátis',
    highlight: false
  }, {
    name: 'Premium',
    price: '79,90',
    period: '/mês',
    features: ['Descrições ilimitadas', 'Todos os templates premium', 'Estrutura completa e otimizada', 'Suporte prioritário e chat exclusivo', 'Aumento de vendas comprovado'],
    cta: 'Assinar Premium',
    highlight: true
  }];
  return <div className="min-h-screen flex flex-col overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <img src="/lovable-uploads/3844fc6f-0538-43f8-a969-8aff8742921b.png" alt="DescriçãoPRO Logo" className="h-10 w-auto mr-3" />
            </div>
            ...
            <div className="hidden md:flex items-center space-x-3">
              {user ? <Button onClick={() => navigate('/editor')} className="bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-700 hover:to-pink-700">
                  Ir para Editor
                </Button> : <>
                  <Button variant="outline" onClick={() => navigate('/auth')} className="border-violet-200 text-violet-600 hover:bg-violet-50">
                    Entrar
                  </Button>
                  <Button onClick={() => navigate('/auth?signup=true')} className="bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-700 hover:to-pink-700">
                    Registrar
                  </Button>
                </>}
            </div>
          ...
          {mobileMenuOpen && <div className="md:hidden mt-4 pb-4 border-t pt-4">
              <div className="flex flex-col space-y-4">
                ...
                <a href="#plans" className="text-gray-600 hover:text-violet-600 transition-colors">Planos</a>
                <a href="#testimonials" className="text-gray-600 hover:text-violet-600 transition-colors">Depoimentos</a>
                {user ? <Button onClick={() => navigate('/editor')} className="bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-700 hover:to-pink-700 w-full">
                    Ir para Editor
                  </Button> : <div className="flex flex-col space-y-2">
                    <Button variant="outline" onClick={() => navigate('/auth')} className="border-violet-200 text-violet-600 hover:bg-violet-50 w-full">
                      Entrar
                    </Button>
                    <Button onClick={() => navigate('/auth?signup=true')} className="bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-700 hover:to-pink-700 w-full">
                      Registrar
                    </Button>
                  </div>}
              </div>
      ...
      <BackgroundBeamsWithCollision className="min-h-screen flex items-center justify-center">
        <div className="container mx-auto px-4 relative z-20">
          <div className="text-center max-w-5xl mx-auto">
            <motion.h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 md:mb-6 leading-tight px-2" initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            duration: 0.8
              ...
              {"Transforme Suas Descrições de Produtos em Máquinas de Vendas".split(" ").map((word, index) => <motion.span key={index} initial={{
              opacity: 0,
              filter: "blur(4px)",
              y: 10
            }} animate={{
            ...
            <motion.p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 mb-6 md:mb-8 max-w-4xl mx-auto leading-relaxed px-4" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            ...
            delay: 0.8
              ...
              <Button size="lg" onClick={() => navigate('/auth?signup=true')} className="bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-700 hover:to-pink-700 text-sm md:text-lg px-6 md:px-8 py-3 md:py-4 h-auto shadow-xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto">
            ...
            delay: 1
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl md:rounded-3xl p-4 md:p-8 shadow-2xl border border-violet-100">
                <img src="/lovable-uploads/b276bca5-ec90-4f48-abdd-dabdc77f5c67.png" alt="DescriçãoPRO - Editor de descrições de produtos" className="w-full h-auto rounded-lg md:rounded-xl shadow-lg" />
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center">
            <div className="bg-gradient-to-br from-violet-50 to-pink-50 p-4 md:p-8 rounded-2xl md:rounded-3xl border border-violet-200 w-full max-w-4xl">
              <Compare firstImage="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d" secondImage="https://images.unsplash.com/photo-1556742111-a301076d9d18" firstImageClassName="object-cover object-left-top" secondImageClassname="object-cover object-left-top" className="h-48 w-full sm:h-64 md:h-80 lg:h-96" slideMode="hover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-12 md:py-24 bg-gradient-to-b from-violet-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto">
            {resources.map((resource, index) => <motion.div key={index} initial={{
            opacity: 0,
            x: -20
          }} whileInView={{
            opacity: 1,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
            ...
            delay: index * 0.2
                ...
                <div className="flex items-center mb-4 md:mb-6">
                  <img src={testimonial.image} alt={testimonial.name} className="w-12 h-12 md:w-16 md:h-16 rounded-full object-cover mr-3 md:mr-4 border-2 border-violet-200" />
                  <div>
                ...
                <div className="flex mb-3 md:mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => <Star key={i} className="h-4 w-4 md:h-5 md:w-5 fill-yellow-400 text-yellow-400" />)}
                </div>
      ...
      <section id="plans" className="py-12 md:py-24 bg-gradient-to-b from-violet-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-6 md:gap-8 max-w-4xl mx-auto">
            ...
            duration: 0.5,
            delay: index * 0.2
          }} className={`bg-white rounded-2xl shadow-xl p-6 md:p-8 border-2 flex-1 relative ${plan.highlight ? 'border-violet-500 bg-gradient-to-br from-white to-violet-50' : 'border-gray-200'}`}>
                {plan.highlight && <div className="absolute -top-3 md:-top-4 left-1/2 transform -translate-x-1/2">
                ...
                <Button className={`w-full ${plan.highlight ? 'bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-700 hover:to-pink-700 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-800'}`} onClick={() => navigate('/auth?signup=true')}>
                  {plan.cta}
                </Button>
              </motion.div>)}
          </div>
      ...
      {/* Final CTA Section */}
      <BackgroundGradientAnimation gradientBackgroundStart="rgb(108, 0, 162)" gradientBackgroundEnd="rgb(0, 17, 82)" firstColor="18, 113, 255" secondColor="221, 74, 255" thirdColor="100, 220, 255" containerClassName="py-12 md:py-24">
        <div className="absolute z-50 inset-0 flex items-center justify-center px-4">
          <div className="text-center max-w-4xl mx-auto">
            <motion.h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            <motion.p className="text-sm sm:text-base md:text-xl text-white/90 mb-6 md:mb-8 leading-relaxed px-4" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            delay: 0.4
              ...
              <Button size="lg" onClick={() => navigate('/auth?signup=true')} className="bg-white text-violet-600 hover:bg-gray-100 text-sm md:text-lg px-6 md:px-8 py-3 md:py-4 h-auto shadow-xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto">
                Começar Agora Gratuitamente
                <ArrowRight className="ml-2 h-4 w-4 md:h-5 md:w-5" />
              </Button>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center mb-3 md:mb-4">
                <img src="/lovable-uploads/3844fc6f-0538-43f8-a969-8aff8742921b.png" alt="DescriçãoPRO Logo" className="h-8 w-auto mr-3" />
              </div>
